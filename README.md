...
- [Programming](#programming)
  ...
  + [programming](#programming-1)
    ...
    - [for M1s_BL808_SDK](#for-m1s_bl808_sdk)
      ...
      + [To program C906 core of BL808 for M1S Dock](#to-program-c906-core-of-bl808-for-m1s-dock)
        - [Option 1 : with U-Disk mode (M1S Specific)](#option-1--with-u-disk-mode-m1s-specific)
        - [Option 2 : with bflb-iot-tool from commandline](#option-2--with-bflb-iot-tool-from-commandline)
- [Debugging](#debugging)
  + [With OpenOCD and JTAG debugger](#with-openocd-and-jtag-debugger)
  + [With C-Sky debug server and CK-Link Lite](#with-c-sky-debug-server-and-ck-link-lite)
    - [Install C-Sky Debug Server](#install-c-sky-debug-server)
    - [Option 1 : Use T-Head / HLK CK-Link Lite Debugger](#option-1--use-t-head-or-hlk-ck-link-debugger)
    - [Option 2 : Use Sipeed RV Debugger Plus or M0S Dock with cklink-lite firmware](#option-2--use-sipeed-rv-debugger-plus-or-m0s-dock-with-cklink-lite-firmware)
    - [Option 3 : Make your own CK-Link Lite debugger with STM32F103](#option-3--make-your-own-ck-link-lite-debugger-with-stm32f103)
    - [Launch C-Sky debug server](#launch-c-sky-debug-server)
    - [Debugging](#debugging-1)
- [Build and run openbouffalo Linux Image for BL808 CPU](#build-and-run-openbouffalo-linux-image-for-bl808-cpu)
  + [Build OpenBouffalo Linux Image](#build-openbouffalo-linux-image)
  + [Program with bflb-iot-tool and flash a SD Card](#program-with-bflb-iot-tool-and-flash-a-sd-card)
  + [Program with BLDevCube and flash a SD Card](#program-with-bldevcube-and-flash-a-sd-card)
  + [Run OpenBouffalo Linux](#run-openbouffalo-linux)
 
- [Miscellaneous](#miscellaneous)
  + [Use Sipeed RV Debugger Plus as JTAG or CK-Link Lite debugger](#how-to-build-and-program-uartjtag-and-dualuart-firmware-for-sipeed-rv-debugger-plus)
  + [Use M0S Dock as CK-Link Lite debugger](#how-to-turn-m0s-dock-to-ck-link-lite)
  + [Sipeed M0sense programming notes](#m0sense-board-bl702-programming-notes)
  + [How to restore factory firmware of M1S Dock](#how-to-restore-factory-firmwares-for-m1s-dock)

- [Deprecated topics]
  + [bl_iot_sdk](#bl_iot_sdk)
  + [Build Linux kernel for BL808](#build-linux-kernel-for-bl808)
    - [Build linux kernel](#build-linux-kernel)
    - [Program linux kernel](#program-linux-kernel)
      + [with bflb-mcu-tool](#with-bflb-mcu-tool)
      + [with BLDevCube](#with-bldevcube)
...
- A devboard with BL chips
  ...
  + [Sipeed M0P and M0P Dock](https://wiki.sipeed.com/hardware/zh/maixzero/m0p/m0p_dock.html): BL618, **[a patch need apply to bouffalo_sdk for Sipeed M0P Dock](./blink_bl616/bouffalo_sdk-patch-for-m0p.patch).**
